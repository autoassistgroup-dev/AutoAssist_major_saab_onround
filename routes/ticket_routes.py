        ...
        if ticket.get('email'):
            try:
                ...
                webhook_payload = {
                    ...
                    'is_email_ticket': ticket.get('is_email_ticket', False),
                    'threadId': ticket.get('threadId') if ticket.get('threadId') else f"thread-{ticket_id}",
                    'message_id': ticket.get('message_id') if ticket.get('message_id') else f"<manual-reply-{ticket_id}@portal.local>",
